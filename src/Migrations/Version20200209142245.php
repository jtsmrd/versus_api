 ...
 */
final class Version20200209142245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competition ADD winner_vote_count INT DEFAULT NULL, CHANGE left_entry_id left_entry_id INT DEFAULT NULL, CHANGE right_entry_id right_entry_id INT DEFAULT NULL, CHANGE winner_user_id winner_user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competition DROP winner_vote_count, CHANGE left_entry_id left_entry_id INT DEFAULT NULL, CHANGE right_entry_id right_entry_id INT DEFAULT NULL, CHANGE winner_user_id winner_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE entry CHANGE match_date match_date DATETIME DEFAULT \'NULL\', CHANGE update_date update_date DATETIME DEFAULT \'NULL\'');
