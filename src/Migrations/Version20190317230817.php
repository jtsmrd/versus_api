 ...
 */
final class Version20190317230817 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE follower CHANGE owner_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE follower CHANGE user_id owner_id INT NOT NULL');
